...
const About = () => {
    const [state] = React.useState({
        heading: 'Jin Kataki ',
        heading2: '3 Years experience',
        text: 'Full-Stack fanatic who converts coffee into code. My previous career as a Filter Technician at Ballast Point Brewing Company revealed my passion for mechanical processes, problem solving, and creating quality products through collaborative teamwork. I specialize in HTML, CSS, JavaScript, and React on the front-end as well as Node || Django and MySQL/Mongo/Postgres on the back-end to create beautiful and secure applications. My biggest priority is developing clear, high-quality code while cultivating a fun and encouraging workplace culture'
    });
    const [sections] = React.useState([
        {
            id: 1,
            icon: <svg width="2.5em" height="2.5em" viewBox="0 0 16 16" className="bi bi-handbag" fill="currentColor"
        ...
        {
            id: 2,
            icon: <svg width="2.5em" height="2.5em" viewBox="0 0 16 16" className="bi bi-tv" fill="currentColor"
                       xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd"
        ...
        {
            id: 3,
            icon: <svg width="2.5em" height="2.5em" viewBox="0 0 16 16" className="bi bi-layers" fill="currentColor"
                       xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd"
            ...
            <div className="container">
                <div className="row">
                    <div className="col-3 " >
                        ...
                        <h4 className="about__h4">{state.heading2}</h4>
                    </div>
                    <div className="col-9">
                        <div className="about__text rtl">
                            <p>{state.text}</p>
                        </div>
                    </div>
                </div>
